        ...
        return (
            <div className="container-fluid">
                ...
                <div className ="container">
                    <div className='row'>
                    <div className="col-lg-3"><img className="rounded float-left" src="https://scontent.fslv1-1.fna.fbcdn.net/v/t1.0-0/p206x206/65121548_340656149936733_3063647902208360448_n.jpg?_nc_cat=110&_nc_ohc=hQmgg3uiGo0AX_PMvDD&_nc_ht=scontent.fslv1-1.fna&_nc_tp=1002&oh=f8c8d71ce2d72d20601ee00146dacdcf&oe=5ED7FE15" alt="varun"/>
                                <hr/>
                                
                    </div>
                    <div className="col-lg-9">  <p>This is full stack react single page application.This project based on adding marks of a perticular subject</p>
